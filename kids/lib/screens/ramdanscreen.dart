      ...
      child: Scaffold(
        body: ListView(
          children: [
            ...
            Ramdanitem(
                'Hadith of the Day', 'assets/images/Group400.png', Hadeth()),
            Ramdanitem('Deed of the Day', 'assets/images/quran.png', Quraan()),
            Ramdanitem('Du`a of the Day', 'assets/images/duaa.png', Dua()),
            SizedBox(
